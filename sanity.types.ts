...
export type AllSanitySchemaTypes = CallToActionObject | SpacerObject | SingleImageObject | ButtonObject | RichTextObject | HeadingObject | SeoObject | MediaBlock | LogoBlock | CallToActionBlock | PortableTextBlock | FreeformBlock | FeaturesMinimalBlock | FeatureCardsBlock | HeaderBlock | HeroBlock | PageBuilder | Post | SanityImageCrop | SanityImageHotspot | Author | PostCategory | SimplerColor | Slug | Redirect | BlogSettings | NavigationSettings | Page | BlogPage | GeneralSettings | HighlightColor | TextColor | MediaTag | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
...
// Variable: postCategorySlugsQuery
// Query: *[_type == "postCategory" && defined(slug.current)] {  "slug": slug.current}
export type PostCategorySlugsQueryResult = Array<{
  slug: string | null;
}>;
...
// Query: *[_type in ["page", "post", "blogPage"] && defined(slug.current)] {    "href": select(      _type == "page" => "/" + slug.current,      _type == "post" => "/blog/" + slug.current,      _type == "blogPage" => "/blog",      slug.current    ),    _updatedAt  }
...
// Query: *[_type == 'generalSettings'][0] {  siteTitle,  siteLogo {     asset->{ url },  },  copyright,}
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"postCategory\" && defined(slug.current)] {\n  \"slug\": slug.current\n}": PostCategorySlugsQueryResult;
